...
type BeaconBadBlob struct {
	...
	Node string `gorm:"index;index:idx_beacon_bad_blob_node_slot_blockroot_fetchedat_network_index_deletedat,priority:1"`
	...
	Network              string         `gorm:"not null;default:'';index;index:idx_beacon_bad_blob_node_slot_blockroot_fetchedat_network_index_deletedat,priority:5;index:idx_beacon_bad_blob_network_deletedat,priority:1;index:idx_beacon_bad_blob_network,where:deleted_at IS NULL;index:idx_beacon_bad_blob_fetchedat_network_deletedat,priority:2"`
	Index                int64          `gorm:"index;index:idx_beacon_bad_blob_node_slot_blockroot_fetchedat_network_index_deletedat,priority:6"`
	DeletedAt            gorm.DeletedAt `gorm:"index;index:idx_beacon_bad_blob_node_slot_blockroot_fetchedat_network_index_deletedat,priority:7;index:idx_beacon_bad_blob_fetchedat_deletedat,priority:2;index:idx_beacon_bad_blob_network_deletedat,priority:2;index:idx_beacon_bad_blob_fetchedat_network_deletedat,priority:3"`
}
