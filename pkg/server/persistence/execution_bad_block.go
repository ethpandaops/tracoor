...
type ExecutionBadBlock struct {
	...
	FetchedAt               time.Time `gorm:"index;index:idx_execution_bad_block_node_blockhash_fetchedat_network_deletedat,priority:2;index:idx_execution_bad_block_fetchedat_deletedat,priority:1;index:idx_execution_bad_block_fetchedat_network_deletedat,priority:1"`
	ExecutionImplementation string
	NodeVersion             string `gorm:"not null;default:''"`
	Location                string `gorm:"not null;default:''"`
	Network                 string `gorm:"not null;default:'';index:idx_execution_bad_block_node_blockhash_fetchedat_network_deletedat,priority:3;index:idx_execution_bad_block_network_deletedat,priority:1;index:idx_execution_bad_block_network,where:deleted_at IS NULL;index:idx_execution_bad_block_fetchedat_network_deletedat,priority:2"`
	...
	DeletedAt               gorm.DeletedAt `gorm:"index;index:idx_execution_bad_block_node_blockhash_fetchedat_network_deletedat,priority:5;index:idx_execution_bad_block_fetchedat_deletedat,priority:2;index:idx_execution_bad_block_network_deletedat,priority:2;index:idx_execution_bad_block_fetchedat_network_deletedat,priority:3"`
}
