...
type BeaconState struct {
	...
	Network              string         `gorm:"not null;default:'';index;index:idx_beacon_state_node_slot_stateroot_network_fetchedat_deletedat,priority:4;index:idx_beacon_state_network_deletedat,priority:1;index:idx_beacon_state_fetchedat_network_deletedat,priority:2"`
