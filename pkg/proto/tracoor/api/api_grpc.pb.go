...
const (
	API_GetConfig_FullMethodName                                = "/api.API/GetConfig"
	...
	API_ListExecutionPayloadEnvelope_FullMethodName             = "/api.API/ListExecutionPayloadEnvelope"
	API_CountExecutionPayloadEnvelope_FullMethodName            = "/api.API/CountExecutionPayloadEnvelope"
	API_ListUniqueExecutionPayloadEnvelopeValues_FullMethodName = "/api.API/ListUniqueExecutionPayloadEnvelopeValues"
...
func (c *aPIClient) ListBeaconState(ctx context.Context, in *ListBeaconStateRequest, opts ...grpc.CallOption) (*ListBeaconStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListBeaconState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CountBeaconState(ctx context.Context, in *CountBeaconStateRequest, opts ...grpc.CallOption) (*CountBeaconStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_CountBeaconState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListUniqueBeaconStateValues(ctx context.Context, in *ListUniqueBeaconStateValuesRequest, opts ...grpc.CallOption) (*ListUniqueBeaconStateValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListUniqueBeaconStateValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListBeaconBlock(ctx context.Context, in *ListBeaconBlockRequest, opts ...grpc.CallOption) (*ListBeaconBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListBeaconBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CountBeaconBlock(ctx context.Context, in *CountBeaconBlockRequest, opts ...grpc.CallOption) (*CountBeaconBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_CountBeaconBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListUniqueBeaconBlockValues(ctx context.Context, in *ListUniqueBeaconBlockValuesRequest, opts ...grpc.CallOption) (*ListUniqueBeaconBlockValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListUniqueBeaconBlockValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListExecutionPayloadEnvelope(ctx context.Context, in *ListExecutionPayloadEnvelopeRequest, opts ...grpc.CallOption) (*ListExecutionPayloadEnvelopeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListExecutionPayloadEnvelopeResponse)
	err := c.cc.Invoke(ctx, API_ListExecutionPayloadEnvelope_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CountExecutionPayloadEnvelope(ctx context.Context, in *CountExecutionPayloadEnvelopeRequest, opts ...grpc.CallOption) (*CountExecutionPayloadEnvelopeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CountExecutionPayloadEnvelopeResponse)
	err := c.cc.Invoke(ctx, API_CountExecutionPayloadEnvelope_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListUniqueExecutionPayloadEnvelopeValues(ctx context.Context, in *ListUniqueExecutionPayloadEnvelopeValuesRequest, opts ...grpc.CallOption) (*ListUniqueExecutionPayloadEnvelopeValuesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUniqueExecutionPayloadEnvelopeValuesResponse)
	err := c.cc.Invoke(ctx, API_ListUniqueExecutionPayloadEnvelopeValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListBeaconBadBlock(ctx context.Context, in *ListBeaconBadBlockRequest, opts ...grpc.CallOption) (*ListBeaconBadBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListBeaconBadBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CountBeaconBadBlock(ctx context.Context, in *CountBeaconBadBlockRequest, opts ...grpc.CallOption) (*CountBeaconBadBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_CountBeaconBadBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListUniqueBeaconBadBlockValues(ctx context.Context, in *ListUniqueBeaconBadBlockValuesRequest, opts ...grpc.CallOption) (*ListUniqueBeaconBadBlockValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListUniqueBeaconBadBlockValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListBeaconBadBlob(ctx context.Context, in *ListBeaconBadBlobRequest, opts ...grpc.CallOption) (*ListBeaconBadBlobResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListBeaconBadBlob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CountBeaconBadBlob(ctx context.Context, in *CountBeaconBadBlobRequest, opts ...grpc.CallOption) (*CountBeaconBadBlobResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_CountBeaconBadBlob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListUniqueBeaconBadBlobValues(ctx context.Context, in *ListUniqueBeaconBadBlobValuesRequest, opts ...grpc.CallOption) (*ListUniqueBeaconBadBlobValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListUniqueBeaconBadBlobValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListExecutionBlockTrace(ctx context.Context, in *ListExecutionBlockTraceRequest, opts ...grpc.CallOption) (*ListExecutionBlockTraceResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListExecutionBlockTrace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CountExecutionBlockTrace(ctx context.Context, in *CountExecutionBlockTraceRequest, opts ...grpc.CallOption) (*CountExecutionBlockTraceResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_CountExecutionBlockTrace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListUniqueExecutionBlockTraceValues(ctx context.Context, in *ListUniqueExecutionBlockTraceValuesRequest, opts ...grpc.CallOption) (*ListUniqueExecutionBlockTraceValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListUniqueExecutionBlockTraceValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListExecutionBadBlock(ctx context.Context, in *ListExecutionBadBlockRequest, opts ...grpc.CallOption) (*ListExecutionBadBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListExecutionBadBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CountExecutionBadBlock(ctx context.Context, in *CountExecutionBadBlockRequest, opts ...grpc.CallOption) (*CountExecutionBadBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_CountExecutionBadBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListUniqueExecutionBadBlockValues(ctx context.Context, in *ListUniqueExecutionBadBlockValuesRequest, opts ...grpc.CallOption) (*ListUniqueExecutionBadBlockValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_ListUniqueExecutionBadBlockValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAPIServer) ListExecutionPayloadEnvelope(context.Context, *ListExecutionPayloadEnvelopeRequest) (*ListExecutionPayloadEnvelopeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListExecutionPayloadEnvelope not implemented")
}
func (UnimplementedAPIServer) CountExecutionPayloadEnvelope(context.Context, *CountExecutionPayloadEnvelopeRequest) (*CountExecutionPayloadEnvelopeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CountExecutionPayloadEnvelope not implemented")
}
func (UnimplementedAPIServer) ListUniqueExecutionPayloadEnvelopeValues(context.Context, *ListUniqueExecutionPayloadEnvelopeValuesRequest) (*ListUniqueExecutionPayloadEnvelopeValuesResponse, error) {
...
func _API_ListExecutionPayloadEnvelope_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListExecutionPayloadEnvelopeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).ListExecutionPayloadEnvelope(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_ListExecutionPayloadEnvelope_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).ListExecutionPayloadEnvelope(ctx, req.(*ListExecutionPayloadEnvelopeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_CountExecutionPayloadEnvelope_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CountExecutionPayloadEnvelopeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).CountExecutionPayloadEnvelope(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_CountExecutionPayloadEnvelope_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).CountExecutionPayloadEnvelope(ctx, req.(*CountExecutionPayloadEnvelopeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_ListUniqueExecutionPayloadEnvelopeValues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListUniqueExecutionPayloadEnvelopeValuesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).ListUniqueExecutionPayloadEnvelopeValues(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_ListUniqueExecutionPayloadEnvelopeValues_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).ListUniqueExecutionPayloadEnvelopeValues(ctx, req.(*ListUniqueExecutionPayloadEnvelopeValuesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _API_ListExecutionPayloadEnvelope_Handler,
		},
		{
			MethodName: "CountExecutionPayloadEnvelope",
			Handler:    _API_CountExecutionPayloadEnvelope_Handler,
		},
		{
			MethodName: "ListUniqueExecutionPayloadEnvelopeValues",
			Handler:    _API_ListUniqueExecutionPayloadEnvelopeValues_Handler,
		},
		{
	...
	Metadata: "pkg/proto/tracoor/api/api.proto",
}
