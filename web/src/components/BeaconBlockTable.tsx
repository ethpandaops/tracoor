...
export default function BeaconBlockTable({ id }: { id?: string }) {
  ...
  return (
    <>
                      ...
                      <tr key={row.id} className="divide-x divide-orange-300">
                        ...
                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-bold text-gray-600">
                          <div className=" w-fit">
                            <span
                              ...
                              onClick={() => setValue('beaconBlockNode', row.node)}
                            >
                              {row.node}
                        ...
                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-bold text-gray-600 hidden 2xl:table-cell">
                          <div className=" w-fit">
                            <span
                              className="relative top-1 group transition cursor-pointer"
                              onClick={() =>
                                setValue('beaconBlockNodeImplementation', row.beacon_implementation)
                              }
                            >
                        ...
                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-bold text-gray-600 hidden 4xl:table-cell">
                          <div className=" w-fit">
                            <span
                              className="relative top-1 group transition cursor-pointer"
                              onClick={() => setValue('beaconBlockNodeVersion', row.node_version)}
                            >
                              {row.node_version}
                              <span className="relative -top-0.5 block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-sky-400"></span>
                            </span>
                        ...
                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-bold text-gray-600 hidden 3xl:table-cell">
                          <div className=" w-fit">
                            <span
                              className="relative top-1 group transition cursor-pointer"
                              onClick={() => setValue('beaconBlockEpoch', row.epoch)}
                            >
                              {row.epoch}
                              <span className="relative -top-0.5 block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-sky-400"></span>
                            </span>
                        ...
                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-bold text-gray-600">
                          <div className=" w-fit">
                            <span
                              className="relative top-1 group transition cursor-pointer"
                              onClick={() => setValue('beaconBlockSlot', row.slot)}
                            >
                              {row.slot}
                              <span className="relative -top-0.5 block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-sky-400"></span>
                            </span>
                        ...
                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-bold text-gray-600 hidden 2xl:table-cell">
                          <div className=" w-fit">
                            <span
                              ...
                              onClick={() => setValue('beaconBlockBlockRoot', row.block_root)}
                            >
                              {row.block_root}
                              <span className="relative -top-0.5 block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-sky-400"></span>
                            </span>
                        ...
                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-bold text-gray-600 w-1">
                          <div className="flex flex-row ">
                            <a
                              href={`/download/beacon_block/${row.id}`}
                              download={`beacon_block-${row.node}-${row.slot}-${row.block_root}.ssz.gz`}
                              className="text-sky-500 hover:text-sky-600 px-2"
                            >
                              <ArrowDownTrayIcon className="h-6 w-6" aria-hidden="true" />
                            </a>
                            <Link href={`/beacon_block/${row.id}`}>
      ...
      <Transition.Root show={Boolean(id)} as={Fragment}>
        <Dialog as="div" onClose={() => setLocation(`/${Selection.beacon_block}`)}>
          <Transition.Child
            as={Fragment}
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              ...
                              onClick={() => setLocation(`/${Selection.beacon_block}`)}
                            >
